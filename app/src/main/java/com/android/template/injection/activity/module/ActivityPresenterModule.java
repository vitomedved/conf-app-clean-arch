...
import com.android.template.ui.event.EventContract;
...
public final class ActivityPresenterModule {
    ...
    @Provides
    @ActivityScope
    EventContract.Presenter provideEventPresenter() {
        final EventPresenter presenter = new EventPresenter((EventContract.View) daggerActivity);
        daggerActivity.getActivityComponent().inject(presenter);
